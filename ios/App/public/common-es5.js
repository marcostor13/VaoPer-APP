...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppPagesModalModalPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ModalPage.prototype, "title", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ModalPage.prototype, "content", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ModalPage.prototype, "modal", void 0);
  ...
  function srcAppServicesGeneralServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var GeneralService = /*#__PURE__*/function () {
      function GeneralService(api, cookie) {
      ...
      _createClass(GeneralService, [{
        key: "httpBuildQuery",
        value: function httpBuildQuery(params) {
        ...
        key: "searchElementByNameKey",
        value: function searchElementByNameKey(array, key, value) {
        ...
        key: "searchIndexByNameKey",
        value: function searchIndexByNameKey(array, key, value) {
          var res = false;
        ...
        key: "getUrlImages",
        value: function getUrlImages(type) {
        ...
        key: "saveEvent",
        value: function saveEvent(type, companyid) {
          var _this = this;
          ...
          if (this.user) {
            ...
            this.api.api(data).subscribe(function (result) {
              _this.api.c('saveEvent', result);
            }, function (error) {
              _this.api.c('Error saveEvent', error);
            });
          } else {
            var _data = {
              type: type,
            ...
            this.api.api(_data).subscribe(function (result) {
              _this.api.c('saveEvent', result);
            }, function (error) {
              _this.api.c('Error saveEvent', error);
            });
        ...
        key: "apertura",
        value: function apertura(start, end) {
          var today = moment__WEBPACK_IMPORTED_MODULE_4__().format('YYYY-MM-DD');
          var betweenStart = today + ' ' + start;
          var betweenEnd = today + ' ' + end;
          var time = moment__WEBPACK_IMPORTED_MODULE_4__().isBetween(betweenStart, betweenEnd);
          return time;
        }
      }, {
        key: "formatURL",
        value: function formatURL(srt) {
