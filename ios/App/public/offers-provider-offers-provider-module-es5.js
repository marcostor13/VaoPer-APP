...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["offers-provider-offers-provider-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesTabsProviderPortfolioOffersProviderOffersProviderPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesTabsProviderPortfolioOffersProviderOffersProviderRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OffersProviderPageRoutingModule", function () {
      return OffersProviderPageRoutingModule;
    });
    /* harmony import */
    ...
    var _offers_provider_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./offers-provider.page */
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        "edit-offers-edit-offers-module").then(__webpack_require__.bind(null,
        /*! ./edit-offers/edit-offers.module */
        "./src/app/pages/tabs-provider/portfolio/offers-provider/edit-offers/edit-offers.module.ts")).then(function (m) {
          return m.EditOffersPageModule;
        });
      }
    }];

    var OffersProviderPageRoutingModule = function OffersProviderPageRoutingModule() {
      _classCallCheck(this, OffersProviderPageRoutingModule);
    };

    OffersProviderPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesTabsProviderPortfolioOffersProviderOffersProviderModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OffersProviderPageModule", function () {
      return OffersProviderPageModule;
    });
    /* harmony import */
    ...
    var _offers_provider_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./offers-provider-routing.module */
    "./src/app/pages/tabs-provider/portfolio/offers-provider/offers-provider-routing.module.ts");
    /* harmony import */


    var _offers_provider_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./offers-provider.page */
    "./src/app/pages/tabs-provider/portfolio/offers-provider/offers-provider.page.ts");
    /* harmony import */
    ...
    var OffersProviderPageModule = function OffersProviderPageModule() {
      _classCallCheck(this, OffersProviderPageModule);
    };

    OffersProviderPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _offers_provider_routing_module__WEBPACK_IMPORTED_MODULE_5__["OffersProviderPageRoutingModule"], ngx_image_cropper__WEBPACK_IMPORTED_MODULE_7__["ImageCropperModule"], ng_zorro_antd_modal__WEBPACK_IMPORTED_MODULE_8__["NzModalModule"]],
  ...
  /***/
  function srcAppPagesTabsProviderPortfolioOffersProviderOffersProviderPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesTabsProviderPortfolioOffersProviderOffersProviderPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OffersProviderPage", function () {
      return OffersProviderPage;
    });
    /* harmony import */
    ...
    var OffersProviderPage = /*#__PURE__*/function () {
      function OffersProviderPage(route, router, api, cookie, general, storage) {
        _classCallCheck(this, OffersProviderPage);
      ...
      _createClass(OffersProviderPage, [{
        key: "ngOnInit",
        ...
        value: function getOffers() {
          ...
          this.api.api(data).subscribe(function (res) {
            _this.api.c('getOffers', res);

            if (res.status) {
              _this.offers = res.data;
            } else {
              _this.api.c('getOffers false', res);
            }
          }, function (error) {
            _this.api.c('getOffers error', error);
          });
        }
      }, {
        key: "deleteOffer",
        value: function deleteOffer(offerid) {
          ...
          this.api.api(data).subscribe(function (res) {
            _this2.api.c('deleteOffer', res);

            _this2.getOffers();
          }, function (error) {
            _this2.api.c('deleteOffer error', error);
          });
        }
      }, {
        key: "getOfferByIdAndDelete",
        value: function getOfferByIdAndDelete(offerid) {
          var _this3 = this;
          ...
          this.api.api(data).subscribe(function (res) {
            _this3.api.c('getOfferByIdAndDelete', res);

            if (res.status) {
              _this3.deleteOffer(offerid);

              _this3.storage.storage.refFromURL(res.data.image)["delete"]();

              _this3.isLoad = false;
            } else {
              _this3.api.c('getOfferByIdAndDelete false', res);

              _this3.isLoad = false;
            }
          }, function (error) {
            _this3.api.c('getOfferByIdAndDelete error', error);
          });
        }
      }, {
        key: "getUriImage",
    ...
    OffersProviderPage.ctorParameters = function () {
      return [{
    ...
    OffersProviderPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-offers-provider',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./offers-provider.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/tabs-provider/portfolio/offers-provider/offers-provider.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./offers-provider.page.scss */
      "./src/app/pages/tabs-provider/portfolio/offers-provider/offers-provider.page.scss"))["default"]]
    })], OffersProviderPage);
    /***/
  }
}]);
//# sourceMappingURL=offers-provider-offers-provider-module-es5.js.map