...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chat-provider-chat-provider-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesTabsProviderChatProviderChatProviderPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesTabsProviderChatProviderChatProviderRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ChatProviderPageRoutingModule", function () {
      return ChatProviderPageRoutingModule;
    });
    /* harmony import */
    ...
    var _chat_provider_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./chat-provider.page */
    ...
    var ChatProviderPageRoutingModule = function ChatProviderPageRoutingModule() {
      _classCallCheck(this, ChatProviderPageRoutingModule);
    };

    ChatProviderPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesTabsProviderChatProviderChatProviderModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ChatProviderPageModule", function () {
      return ChatProviderPageModule;
    });
    /* harmony import */
    ...
    var _chat_provider_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./chat-provider-routing.module */
    "./src/app/pages/tabs-provider/chat-provider/chat-provider-routing.module.ts");
    /* harmony import */


    var _chat_provider_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./chat-provider.page */
    "./src/app/pages/tabs-provider/chat-provider/chat-provider.page.ts");

    var ChatProviderPageModule = function ChatProviderPageModule() {
      _classCallCheck(this, ChatProviderPageModule);
    };

    ChatProviderPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _chat_provider_routing_module__WEBPACK_IMPORTED_MODULE_5__["ChatProviderPageRoutingModule"]],
  ...
  /***/
  function srcAppPagesTabsProviderChatProviderChatProviderPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesTabsProviderChatProviderChatProviderPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ChatProviderPage", function () {
      return ChatProviderPage;
    });
    /* harmony import */
    ...
    var ChatProviderPage = /*#__PURE__*/function () {
      function ChatProviderPage(firestore, api, cookie, router, route) {
        var _this = this;

        _classCallCheck(this, ChatProviderPage);
        ...
        this.validateSession(this.id); //get notifications

        firestore.collection('chatnotification_' + this.user.user.id).valueChanges().subscribe(function (res) {
          _this.api.c('Notifications', res);

          _this.noti = res;
        }); //get Chats

        this.chats = firestore.collection('chatlist_' + this.user.user.id, function (ref) {
          return ref.orderBy('date', 'desc');
        }).valueChanges();
        this.chats.forEach(function (res) {
          _this.api.c('Chats', _this.notifications);

          res.forEach(function (item) {
            _this.api.c('Chats item ', item);

            _this.getNameReceptop(item.receptor);
          });
        });
        moment__WEBPACK_IMPORTED_MODULE_6__["locale"]("es");
      }

      _createClass(ChatProviderPage, [{
        key: "getNotification",
        value: function getNotification(id) {
          var notifi = 0;

          for (var index = 0; index < this.noti.length; index++) {
            var element = this.noti[index];
        ...
        key: "validateSession",
        value: function validateSession(iduserchat) {
          if (!localStorage.getItem('ud') || localStorage.getItem('ud') == '') {
            this.router.navigate(['/login']);
          } else {
            this.user = JSON.parse(localStorage.getItem('ud')); // if (this.user.user.role !== "proveedor" && this.user.user.role !== "admin") {
        ...
        key: "getNameReceptop",
        value: function getNameReceptop(id) {
          var _this2 = this;
          ...
          this.api.api(data).subscribe(function (res) {
            _this2.api.c('getNameReceptop', res);

            _this2.dataUsers[id] = res;
            _this2.dataUsers = _this2.dataUsers;

            _this2.api.c('dataUsers', _this2.dataUsers);
          }, function (error) {
            _this2.api.c('getProducts error', error);
          });
        }
      }, {
        key: "getMessages",
        value: function getMessages(idReceptor) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
            var _this3 = this;

            var self, collection, collectionReverse, collectionChatNotification;
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    collection = 'chat_' + this.user.user.id + '_' + idReceptor;
                    collectionReverse = 'chat_' + idReceptor + '_' + this.user.user.id;
                    collectionChatNotification = 'chatnotification_' + this.user.user.id;
                    _context4.next = 7;
                    return this.firestore.collection(collection).get().subscribe(function (res) {
                        ...
                        return regeneratorRuntime.wrap(function _callee3$(_context3) {
                          while (1) {
                            switch (_context3.prev = _context3.next) {
                              case 0:
                                _context3.next = 2;
                                return this.firestore.collection(collectionChatNotification).get().subscribe(function (res) {
                                      ...
                                      return regeneratorRuntime.wrap(function _callee2$(_context2) {
                                        while (1) {
                                          switch (_context2.prev = _context2.next) {
                                            case 0:
                                              this.firestore.collection(collectionChatNotification).doc(doc.id).get().subscribe(function (result) {
                                                    ...
                                                    while (1) {
                                                      switch (_context.prev = _context.next) {
                                                        case 0:
                                                          ...
                                                          _context.next = 3;
                                                          return this.firestore.collection(collectionChatNotification).doc(result.id)["delete"]();
                              ...
                              case 2:
                                if (res.size != 0) {
                                  this.messages = this.firestore.collection(collection, function (ref) {
                                    return ref.orderBy('date');
                                  }).valueChanges();
                                } else {
                                  this.messages = this.firestore.collection(collectionReverse, function (ref) {
                                    return ref.orderBy('date');
                                  }).valueChanges();
                                }

                                this.messages.subscribe(function (res) {
                                  setTimeout(function () {
                                    self.scrollToBottom();
                                  }, 2000);
                                });
    ...
    ChatProviderPage.ctorParameters = function () {
      return [{
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('scrollMe2', {
      "static": false
    })], ChatProviderPage.prototype, "scrollMe2", void 0);
    ChatProviderPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-chat-provider',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./chat-provider.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/tabs-provider/chat-provider/chat-provider.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./chat-provider.page.scss */
      "./src/app/pages/tabs-provider/chat-provider/chat-provider.page.scss"))["default"]]
    })], ChatProviderPage);
    /***/
  }
}]);
//# sourceMappingURL=chat-provider-chat-provider-module-es5.js.map