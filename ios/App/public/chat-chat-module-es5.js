...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chat-chat-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesTabsChatChatPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesTabsChatChatRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesTabsChatChatModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesTabsChatChatPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesTabsChatChatPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ChatPage = /*#__PURE__*/function () {
      function ChatPage(firestore, api, cookie, router, route) {
        var _this = this;
      ...
      _createClass(ChatPage, [{
        key: "invertChatid",
        value: function invertChatid(id) {
          var ids = id.split('_');
        ...
        value: function getNameReceptop(id) {
          ...
          this.api.api(data).subscribe(function (res) {
            _this3.api.c('getNameReceptop', res);

            _this3.dataUsers[id] = res;
            _this3.dataUsers = _this3.dataUsers;

            _this3.api.c('dataUsers', _this3.dataUsers);
          }, function (error) {
            _this3.api.c('getProducts error', error);
          });
        }
      }, {
        key: "getMessages",
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    this.firestore.collection(collection).get().subscribe(function (res) {
                        ...
                        return regeneratorRuntime.wrap(function _callee3$(_context3) {
                          while (1) {
                            switch (_context3.prev = _context3.next) {
                              case 0:
                                this.firestore.collection(collectionChatNotification).get().subscribe(function (res) {
    ...
    ChatPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/tabs/chat/chat.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./chat.page.scss */
      "./src/app/pages/tabs/chat/chat.page.scss"))["default"]]
    })], ChatPage);
    /***/
  }
}]);
