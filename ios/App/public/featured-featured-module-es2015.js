...
/* harmony import */ var _featured_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./featured.page */ "./src/app/pages/tabs/featured/featured.page.ts");
...
/* harmony import */ var _featured_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./featured-routing.module */ "./src/app/pages/tabs/featured/featured-routing.module.ts");
/* harmony import */ var _featured_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./featured.page */ "./src/app/pages/tabs/featured/featured.page.ts");
...
let FeaturedPage = class FeaturedPage {
    constructor(route, router, api, cookie, general, socialSharing) {
        this.route = route;
        this.router = router;
        this.api = api;
        this.cookie = cookie;
            ...
            this.api.api(data).subscribe((result) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                ...
                if (result.status) {
                    if (result.data.length > 0) {
                        this.response = '';
                        this.isLoad = false;
                        this.companiesData = yield this.getCurrentPosition(result.data);
...
FeaturedPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./featured.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/tabs/featured/featured.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./featured.page.scss */ "./src/app/pages/tabs/featured/featured.page.scss")).default]
    })
], FeaturedPage);
